        ...
        >
          ...
          >
            ...
            >
              ...
              <strong style={{ color: "#FFC300" }}>
                #{rejectModal.venta?.id}
              </strong>
          ...
          <div className="ventas-table-container">
            <div className="ventas-table-wrapper yellow-scrollbar">
              <EntityTable
                ...
                onApprove={(v) =>
                  updateVentaStatus(availableStatuses[1], "", null, v.id)
                }
              ...
              >
                <div className="total-summary">
                  ...
                  <span className="total-value" style={{ textShadow: "none" }}>
                    $
                    {calcularTotalViendo().toLocaleString("es-CO", {
                      minimumFractionDigits: 0,
                      maximumFractionDigits: 0,
                    })}
                  </span>
