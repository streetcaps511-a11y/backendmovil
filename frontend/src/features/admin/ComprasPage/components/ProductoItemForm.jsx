    ...
    return (
      <div style={{ backgroundColor: "transparent", padding: "8px 4px" }}>
        ...
        >
          ...
          <div>
            <div style={{ ...readStyle, fontWeight: "600" }}>
              {producto.nombre || "-"}
            </div>
          ...
          <div>
            <div style={{ ...readStyle, color: "#10B981", fontWeight: "700" }}>
              ${formatNumber(producto.precioCompra)}
            </div>
          </div>
          <div>
            <div style={{ ...readStyle, color: "#F5C81B", fontWeight: "700" }}>
              ${formatNumber(producto.precioVenta)}
            </div>
          </div>
          <div>
            <div style={{ ...readStyle, color: "#cbd5e1" }}>
        ...
        {/* Cierre del grid de la línea 72 */}
        <div
          style={{
            display: "flex",
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            <span
              style={{ fontSize: "10px", color: "#94a3b8", fontWeight: "800" }}
            >
              {producto.nombre || ""}
            </span>
            <div
  ...
  return (
    ...
    >
      ...
      >
          ...
          <div style={{ display: "flex", gap: "4px", alignItems: "center" }}>
            ...
            <button
              ...
              style={{
                ...
                flexShrink: 0,
                boxShadow: showSelector
                  ? "0 0 10px rgba(245, 200, 27, 0.4)"
                  : "none",
              }}
              onMouseEnter={(e) => {
            ...
            >
                ...
                >
                  ...
                  <select
                    ...
                    style={{
                      ...
                      padding: "0 2px",
                      textTransform: "capitalize",
                      border: errors[`talla_${index}_${vi}`]
                        ? "1px solid #ef4444"
                        : "1px solid #ffffff15",
                    }}
                  >
              ...
              {(producto.variantes || []).length < 4 && (
                <button
                  ...
                  onMouseEnter={(e) =>
                    (e.currentTarget.style.border = "1px dashed #F5C81B")
                  }
                  onMouseLeave={(e) =>
                    (e.currentTarget.style.border = "1px dashed #F5C81B50")
                  }
                >
                  + Talla
                </button>
        ...
        {/* Eliminar / Limpiar */}
        <div
          style={{ display: "flex", alignItems: "center", paddingTop: "0px" }}
        >
          <button
            type="button"
